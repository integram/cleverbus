...
public class ArchivingDatabaseScriptJob implements ProcessArchivingDataJob {
    ...
    public void startArchivingData() {
        ...
        procedureArchive.registerStoredProcedureParameter("archiveOlderInMonth", Integer.class, ParameterMode.IN);
        procedureArchive.setParameter("archiveOlderInMonth", archiveOlderInDays);
