...
public class LogParserConstants {
    ...
    public static final Pattern LOG_LINE_DATE_PATTERN = Pattern.compile(
            "^(${symbol_escape}${symbol_escape}d{4}-${symbol_escape}${symbol_escape}d{2}-${symbol_escape}${symbol_escape}d{2}[ T]${symbol_escape}${symbol_escape}d{2}:${symbol_escape}${symbol_escape}d{2}:${symbol_escape}${symbol_escape}d{2}[,.]${symbol_escape}${symbol_escape}d{3})");
    /**
     ...
     * <p/>
     * %d{ISO8601} [${symbol_dollar}{MACHINE}, %thread, %X{REQUEST_URI}, %X{REQUEST_ID}, %X{SESSION_ID}, %X{SOURCE_SYSTEM}, %X{CORRELATION_ID}] %-5level %logger{36} - %msg%n
     */
    public static final Pattern LOG_LINE_PROPERTIES_PATTERN = Pattern.compile(
            ...
            "${symbol_escape}${symbol_escape}s+${symbol_escape}${symbol_escape}[(.*?), (.*?), (.*?), (.*?), (.*?), (.*?), (.*?), (.*?)${symbol_escape}${symbol_escape}]${symbol_escape}${symbol_escape}s+(${symbol_escape}${symbol_escape}S+)${symbol_escape}${symbol_escape}s+(${symbol_escape}${symbol_escape}S+)${symbol_escape}${symbol_escape}s+-${symbol_escape}${symbol_escape}s+");
    /**
     * Group names in the same order they are present in {@link ${symbol_pound}LOG_LINE_PROPERTIES_PATTERN}.
     */
