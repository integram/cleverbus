...
-   **web-admin**: [admin GUI](../User-guide/Admin-GUI) web application
...
-   **h2 (default):** database [H2](http://www.h2database.com) in embedded in-memory mode, more information in chapter about [H2 database](../Running-CleverBus/H2-database)
